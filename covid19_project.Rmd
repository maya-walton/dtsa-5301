...
download.file((urls[1]), destfile = "global.csv")
download.file((urls[4]), destfile = "global_deaths.csv")
download.file((urls[2]), destfile = "us_cases.csv")
download.file((urls[3]), destfile = "us_deaths.csv")
download.file(uid_lookup_url, "uid_lookup.csv")
...
#global_cases <- read.csv("global.csv")
#global_deaths <- read.csv("global_deaths.csv")
#us_cases <- read.csv("us_cases.csv")
#us_deaths <- read.csv("us_deaths.csv")
#uid_lookup <- read.csv("uid_lookup.csv") %>% select(c(Combined_Key, Population, Admin2))
...
#global_cases$date <- substring(global_cases$date, 2)
global_cases$date <- as.Date(global_cases$date, "X%m.%d.%y")
...
#global_deaths$date <- substring(global_deaths$date, 2)
global_deaths$date <- as.Date(global_deaths$date, "X%m.%d.%y")
...
#us_cases$date <- substring(us_cases$date, 2)
us_cases$date <- as.Date(us_cases$date, "X%m.%d.%Y")
...
#us_deaths$date <- substring(us_deaths$date, 1)
us_deaths$date <- as.Date(us_deaths$date, "X%m.%d.%Y")
```
